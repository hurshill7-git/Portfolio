...
// Click Effects — Originkit, adapted as a global full-viewport overlay:
// fixed positioning (so click coords map 1:1 to viewport coords regardless of
// scroll), theme-aware accent color, and skipped under prefers-reduced-motion
// to match the rest of the site's motion components.
...
export function MouseEffects({
  ...
  }, [enabled, interactionMode, effectSize]);
