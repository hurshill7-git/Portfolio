...
<ProcessSteps>
  <Step n="01" title="Broke down the transcript">Split it into a sequence of image prompts, one per shot.</Step>
  <Step n="02" title="Generated the frames">Freepik Spaces produced the stills, using Google's image generator for any shot with on-screen text so the words stayed legible.</Step>
  <Step n="03" title="Turned frames into motion">Google Veo 3 and Grok animated each frame, fed a first and last frame to control the shot.</Step>
  <Step n="04" title="Generated the voiceover">ElevenLabs turned the script into narration.</Step>
  <Step n="05" title="Cut it together">Assembled everything in Premiere Pro, nudging clip pace up or down to lock the visuals to the voice.</Step>
</ProcessSteps>
