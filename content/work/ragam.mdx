...
<ProcessSteps>
  <Step n="01" title="Mapped the user flows">Homepage branching into New Releases, Trending, Contact, Account, and the side menu, each traced through to payment and a Thank You screen.</Step>
  <Step n="02" title="Sketched the screens">Nine screens on paper first: onboarding, browse, movie details, contact, feedback, and booking.</Step>
  <Step n="03" title="Set the type and colour system">Lemon/Milk and Century Gothic, paired with the theatre's own black, orange, and red.</Step>
  <Step n="04" title="Built the wireframes">Greyscale versions of every core screen, home, login, sign up, movie details, side menu, booking summary, before touching colour.</Step>
  <Step n="05" title="Designed the UI and wired the prototype">The part I owned: the final screens (trending, seat map, contact) and a clickable Figma prototype across three flows.</Step>
</ProcessSteps>
...
<Gallery cols={3}>
  <Figure alt="Trending screen with movie posters" aspect="portrait" />
  <Figure alt="Seat selection screen" aspect="portrait" />
  <Figure alt="Contact page with theatre locations" aspect="portrait" />
</Gallery>
